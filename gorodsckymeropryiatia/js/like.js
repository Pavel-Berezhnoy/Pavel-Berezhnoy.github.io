...
function like(id_post){
  id_post_split = id_post.split('_')[1];
  Request = CreateRequest();
    JSONobj = {
      id_post: id_post_split,
      do_like: "like"
    }
      Request.open("POST",'../php/do-like.php');
      console.log(JSONobj);
