...
$query = 'SELECT posts.id_post,name,description,img, COUNT(likes.id_post) AS likes from posts left join likes on posts.id_post = likes.id_post GROUP BY posts.id_post ORDER BY likes DESC LIMIT 5';
